...
import com.juzipi.mark.meta.enums.FileGenerateTypeEnum;
import com.juzipi.mark.meta.enums.FileTypeEnum;
import com.juzipi.mark.meta.enums.ModelTypeEnum;
    ...
    public static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo : modelInfoList) {
            ...
            if (StrUtil.isEmpty(modelInfoType)) {
                modelInfo.setType(ModelTypeEnum.SRING.getText());
            }
        }
    }
